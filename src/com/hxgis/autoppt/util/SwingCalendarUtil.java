 ...
 * 修改/完善：YouAreStupid
 */
public class SwingCalendarUtil extends JButton {
    ...
    public SwingCalendarUtil() {
        this(getNowDate());
    }
 
    public SwingCalendarUtil(String dateString) {
        this();
    ...
    public SwingCalendarUtil(SimpleDateFormat df, String dateString) {
        this();
    ...
    public SwingCalendarUtil(Date date) {
        this("", date);
        //记忆原始日期时间
        initOriginalText(date);
    }
 
    public SwingCalendarUtil(String preLabel, Date date) {
        if (preLabel != null) {
    ...
    private class DateChooser extends JPanel implements ActionListener, ChangeListener {
        ...
        void showDateChooser(Point position) {
            Frame owner = (Frame) SwingUtilities.getWindowAncestor(SwingCalendarUtil.this);
    ...
    public static void main(String[] args) {
        ...
        mainFrame.add(new SwingCalendarUtil(), java.awt.BorderLayout.CENTER);
